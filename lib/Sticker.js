...
async function addExif(webpSticker, info) {
  ...
  const json = { 'sticker-pack-id': stickerPackId, 'sticker-pack-name': (info.packname || ''), 'sticker-pack-publisher': (info.author || ''), 'emojis': (info.categories || ['💖']), 'android-app-store-link': 'https://github.com/naxordeve/whatsapp-bot', 'ios-app-store-link': 'https://github.com/naxordeve/whatsapp-bot' };
