      ...
      if (msg.body?.startsWith('$')) {
          ...
          try {
              ...
              for (const command of getCommand()) {
                  if (command.on) {
                      if ((command.on === "text" && msg.type === "conversation") ||
                          (command.on === "video" && msg.type === "videoMessage") ||
                          (command.on === "audio" && msg.type === "audioMessage") ||
                          (command.on === "sticker" && msg.type === "stickerMessage") ||
                          (command.on === "image" && msg.type === "imageMessage")
                      ) {
