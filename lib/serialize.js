...
const serialize = (msg, conn) => {
    ...
    const m = {
        ...
        send: (content, type = 'text', options = {}) => send(msg, conn, content, type, options),
...
const send = async (msg, conn, content, type = 'text', options = {}) => {
    ...
    // Add edit functionality if edit key is provided
    if (options.edit) {
        conteg.edit = options.edit;
    }
